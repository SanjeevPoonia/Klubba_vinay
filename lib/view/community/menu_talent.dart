...
class menuTalent extends StatefulWidget{
  _menuTalent createState()=>_menuTalent();
}
class _menuTalent extends State<menuTalent>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        floatingActionButton: new FloatingActionButton(
            elevation: 5.0,
            child: new Icon(Icons.add,color: AppTheme.themeColor),
                          ...
                          child: Row(
                            children: [
                              ...
                              postList[pos].toString().contains(
                                  "user_profile_image") && postList[pos]["user_profile_image"]!=""
                                  ? CircleAvatar(
                                radius: 18,
                                backgroundImage:
                              ...
                              Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    postOptionsBottomSheet(postList[pos]["user_id"],
                                        postList[pos]["_id"]);
                                  },
                                  child: Image.asset(
                                      "assets/menu_icc.png",
  ...
  postOptionsBottomSheet(String friendID, String postID) {
    showGeneralDialog(
      barrierLabel: "Label",
