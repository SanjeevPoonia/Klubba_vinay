...
class menuAnnoucements extends StatefulWidget{
  _menuAnnouncement createState()=>_menuAnnouncement();
}
class _menuAnnouncement extends State<menuAnnoucements>{

  bool isLoading=false;
  int selectedMoreIndex=9999;
  List<String> moreList=["Report"];
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: GestureDetector(
                                            onTap: () {
                                              postOptionsBottomSheet(postList[pos]["_id"]);
                                            },
                                            child: Image.asset(
                                                "assets/menu_icc.png",
                                                width: 15,
...
*/
  ...
  postOptionsBottomSheet(String postID) {
    showGeneralDialog(
      barrierLabel: "Label",
  ...
  fetchPosts() async {
    ...
    isLoading = false;
    if(responseJSON['decodedData']['result']!="No post available")
      {
