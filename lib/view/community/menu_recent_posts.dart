...
class MenuMyPostScreen extends StatefulWidget {
  CommunityState createState() => CommunityState();
}

class CommunityState extends State<MenuMyPostScreen> {
    ...
    return Scaffold(
      ...
      body: isLoading
          ...
          postList.length==0?
              ...
              Center(
                child: Text("You have not posted anything"),
              ):
           ...
           ListView.builder(
              ...
              itemBuilder: (BuildContext context, int pos) {
                ...
                if (postList[pos].toString().contains("repostData")) {
                ...
                } else if (postList[pos].toString().contains("survey_title")) {
                ...
                if (postList[pos].toString().contains("repostData")) {
                  if (postList[pos]["repostData"]
                      .toString()
                      .contains("images")) {
                    if (postList[pos]["repostData"]["images"] != null) {
                      mediaFiles = postList[pos]["repostData"]["images"];
                    }
                  }
                  ...
                  if (postList[pos]["repostData"]
                      .toString()
                      .contains("video")) {
                    if (postList[pos]["repostData"]["video"] != null) {
                      mediaFiles =
                          mediaFiles + postList[pos]["repostData"]["video"];
                    }
                  }
                } else {
                  ...
                  if (postList[pos].toString().contains("video")) {
                    mediaFiles = mediaFiles + postList[pos]["video"];
                  }
                }
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: Image.asset("assets/menu_icc.png",
                                          width: 15, height: 15),
                                    ),
                                  ),
                                  SizedBox(width: 10),
                          ...
                          postList[pos].toString().contains("repostData")
                                                          ...
                                                          children: [
                                                            InkWell(
                                                              child: Container(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    selectedValue.toString().contains(pos.toString() +
                                                                            "," +
                                                                            index22
                                                                                .toString())
                                                                        ? Icon(
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        ...
                                                                        Column(
                                                                          children: [
                                                                            Text(
                                                                              returnEventMonth(postList[pos]["repostData"]["event_start_date"].toString()),
                                                                              style: TextStyle(color: Color(0xFFFF0200), fontWeight: FontWeight.w500, fontSize: 12),
                                                                            ),
                                                                            Text(
                                                                              returnEventDateSeparate(postList[pos]["repostData"]["event_start_date"].toString()),
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          crossAxisAlignment:
                                                                              CrossAxisAlignment.start,
                                                                          children: [
                                                                            Text(postList[pos]["repostData"]["event_name"],
                                                                                style: TextStyle(fontSize: 13, fontFamily: "Poppins", color: AppTheme.blueColor, fontWeight: FontWeight.w500)),
                                                                            Text(returnEventDate(postList[pos]["repostData"]["event_start_date"].toString()) + "-" + returnEventDate(postList[pos]["repostData"]["event_end_date"].toString()),
                                                                                style: TextStyle(
                                                                                  fontSize: 9,
                                                                                  fontFamily: "Poppins",
                                                                                  color: Color(0xFFB1B1B1),
                                                        ...
                                                        children: [
                                                          InkWell(
                                                            child: Container(
                                                              ...
                                                              child: Row(
                                                                children: [
                                                                  selectedValue.toString().contains(pos
                                                                              .toString() +
                                                                          "," +
                                                                          index22
                                                                              .toString())
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Column(
                                                                    children: [
                                                                      Text(
                                                                        returnEventMonth(
                                                                            postList[pos]["event_start_date"].toString()),
                                                                        style: TextStyle(
                                                                            color:
                                                                                Color(0xFFFF0200),
                                                                            fontWeight: FontWeight.w500,
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                          ...
                                                                          style: TextStyle(
                                                                              ...
                                                                              fontWeight: FontWeight.w500)),
                                                                      Text(
                                                                          returnEventDate(postList[pos]["event_start_date"].toString()) +
                                                                              "-" +
                                                                              returnEventDate(postList[pos]["event_end_date"]
                                                                                  .toString()),
                                                                          style:
                                                                              TextStyle(
                                                                            fontSize:
...
*/
                                    ...
                                    Container(
                                      ...
                                      child: ListView.builder(
                                          ...
                                          itemBuilder: (BuildContext context,
                                            ...
                                            String currentEmoji = postList[pos]
                                                ["like"][pos22]["liked_type"];

                                            if (postList[pos]["like"].length >
                                                1) {
                                              print(pos22.toString());
                                              for (int i = pos22 - 1;
                                                  i >= 0;
                                                  i--) {
                                                if (postList[pos]["like"][i]
                                                        ["liked_type"] ==
                                                    currentEmoji) {
                                                  showEmojis = false;
                                                  break;
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    postList[pos]["selfLike"].length != 0
                                        ? GestureDetector(
                                            child: Image.asset(
                                    ...
                                    SizedBox(width: 5),
                                    Text(
                                        postList[pos]["like"].length.toString(),
                                        style: TextStyle(
                                          fontSize: 11.5,
                                          fontWeight: FontWeight.w500,
                                          color: Colors.black,
  ...
  deletePost(String postID, int pos) async {
    ...
    ApiBaseHelper helper = ApiBaseHelper();
    var response =
        await helper.postAPIWithHeader('deletePost', requestModel, context);
    var responseJSON = json.decode(response.body);
