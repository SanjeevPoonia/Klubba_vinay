...
class CategoryState extends State<SelectCategoryScreen> {
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: (){
                                        showCategoryRemoveDialog(addedCategoryList[pos]['category_id'],pos);
                                      },
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Divider(),
                    Container(
                      height:categoryList.length>4? 250:170,
                      child: Scrollbar(
                        child: ListView.builder(
...
/*
  ...
  showCategoryRemoveDialog(String catId,int pos) {
  ...
  _deleteCategory(String catID,int pos) async {
    ...
    ApiBaseHelper helper = ApiBaseHelper();
    var response = await helper.postAPI(
        'deleteLearnerCategory', requestModel, context);
    var responseJSON = json.decode(response.body);
    Navigator.pop(context);
