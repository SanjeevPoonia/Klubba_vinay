...
class AddAssignmentScreen extends StatefulWidget {
  ...
  AddAssignmentScreen(this.date);

  AssignmentState createState() => AssignmentState();
}

class AssignmentState extends State<AddAssignmentScreen> {
  bool defaultLayout = true;
  List<dynamic> fileData=[null];
  ...
  List<String> assignmentList=["One"];

  List<TextEditingController>? _controllersTitle = [];
  List<TextEditingController>? _controllersInstruction = [];
            ...
            appBar: AppBar(
              ...
              leading: IconButton(
                icon: const Icon(Icons.arrow_back_ios_new_sharp,
                    color: Colors.black),
                onPressed: () => Navigator.pop(context,"Refresh Data"),
              ),
              title: RichText(
                text: TextSpan(
                  style: TextStyle(
            ...
            body: defaultLayout
                ? ListView(
                    children: [
                      ...
                      {
                        _controllersTitle!.add(TextEditingController());
                        _controllersInstruction!.add(TextEditingController());
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                pos==0?
                                    ...
                                    child: GestureDetector(
                                        child: Icon(Icons.delete,color: AppTheme.blueColor),onTap: (){
                                      assignmentList.removeAt(pos);
                                      fileData.removeAt(pos);
                                      setState(() {
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                  validator: checkEmptyString,
                                  controller: _controllersTitle![pos],
                                  style: const TextStyle(
                                    fontSize: 15.0,
                                    color: Colors.black,
                                  ),
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                      onTap: () async {
                                        ...
                                        print("Model Value");
                                        print(AppModel.fileData);
                                        print(fileData.length.toString());

                                        print(pos.toString()+"POS");

                                        if(AppModel.fileData!.isNotEmpty)
                                          {
                                            fileData[pos]=AppModel.fileData;
                                            setState(() {});
                                      ...
                                      child: fileData.isNotEmpty && fileData[pos].toString().contains("library_type")
                                          ? fileData[pos]['library_type'] == "video"
                                  ...
                                  GestureDetector(
                                    ...
                                    child: fileData.isNotEmpty && fileData[pos].toString().contains("library_type")
                                        ? fileData[pos]['library_type'] == "image"
                            ...
                            Container(
                              ...
                              margin: const EdgeInsets.symmetric(horizontal: 8),
                              child: TextFormField(
                                  controller: _controllersInstruction![pos],
                                  style: const TextStyle(
                                    fontSize: 15.0,
                                    color: Colors.black,
                                  ),
  ...
  pasteItems(){
    print(AppModel.copyData);

    if(AppModel.copyData!=null)
      {
        titleController.text=AppModel.copyData!["title"];
        descController.text=AppModel.copyData!["description"];
        if(AppModel.copyData!["activities"].length!=0)
        {
          assignmentTitleController.text=AppModel.copyData!["activities"][0]["title"];
          assignmentDescController.text=AppModel.copyData!["activities"][0]["description"];
        }
      ...
      {
        Toast.show("Sorry you have not copied any activity !!",
            duration: Toast.lengthShort,
            gravity: Toast.bottom,
            backgroundColor: Colors.red);
      }
    ...
    for(int i=0;i<assignmentList.length;i++)
      {
        Map<String,dynamic> data= {
          "title":_controllersTitle![i].text,
          "description":_controllersInstruction![i].text,
          "type": null,
          "attchement": fileData[i]!=null && fileData[i]!['library_type']=="video"?{
            "video_id": fileData[i]!['_id'],
            "slug": fileData[i]!['slug'],
            "video_type": fileData[i]!['video_type'],
            "video_url": fileData[i]!['library_video_url'],
            "video_thumb":fileData[i]!['video_thumb'],
            "view_count": fileData[i]!['view_count']
          }:null,
          "attchement_image": fileData[i]!=null? fileData[i]!['library_type']=="image"?fileData[i]!['_id']:null:null,
          "attchement_pdf":fileData[i]!=null? fileData[i]!['library_type']=="pdf"?fileData[i]!['_id']:null:null,
          "attachment_type":
          fileData[i] != null ? fileData[i]!['library_type'] : null
        };
