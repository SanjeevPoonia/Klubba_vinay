...
class NewSelfAssesmentScreen extends StatefulWidget {
  SelfState createState() => SelfState();
}

class SelfState extends State<NewSelfAssesmentScreen> {
  ...
  fetchAssesments(String catID) async {
    ...
    String? id = await MyUtils.getSharedPreferences('_id');
     ...
     var data = {
      "method_name": "getCompletedAttributes",
      "data": {
        "user_id": id,
        "slug": AppModel.slug,
    ...
    var response =
        await helper.postAPI('getCompletedAttributes', requestModel, context);
