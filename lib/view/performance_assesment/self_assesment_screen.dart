...
class SelfAssesmentScreen extends StatefulWidget {
  SelfState createState() => SelfState();
}

class SelfState extends State<SelfAssesmentScreen> {
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                            ...
                            /*  Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          AddAssesmentScreen(draftMap,attributes)));*/
                            }),
                      ),
                      SizedBox(height: 8),
                    ],
...
/*
    var data={"method_name":"getUserAssessment","data":{"user_slug":"ankit-pareek","type":"self","orderColumn":"created","orderDir":"desc","pageNumber":0,"pageSize":30,"current_stage_id":"5d496c2de67f81784a9ddc39","slug":"ankit-pareek","current_role":"5d4d4f960fb681180782e4f4","current_category_id":"5da82b8753f9777a94999710","action_performed_by":"615416ef6655186f0341da33"}};
*/
    ...
    if(assesmentList.length!=0)
      {
        selectedWeekIndex=assesmentList.length-1;
      }
