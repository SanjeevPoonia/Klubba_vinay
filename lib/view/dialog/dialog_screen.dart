...
class DialogState extends State<DialogScreen> {
                           ...
                           children: [
                             Expanded(
                               child: Container(
                                 ...
                                 child: Text(
                                     packFeatures[pos]["feature"]=="Email"?
                                     "50 "+packFeatures[pos]["feature"]:
                                     packFeatures[pos]["feature"]=="SMS"?

                                     "100 "+packFeatures[pos]["feature"]:


                                     packFeatures[pos]["feature"]=="Space" && pagePosition==0?
                                     "1024 MB "+packFeatures[pos]["feature"]:


                                     packFeatures[pos]["feature"]=="Space" && pagePosition==1?
                                     "1 MB "+packFeatures[pos]["feature"]:
                                     packFeatures[pos]["feature"],
                                     style: TextStyle(
                                         color: AppTheme.blueColor,
                                         fontWeight: FontWeight.w600,
                                         fontSize: 12.5)),
