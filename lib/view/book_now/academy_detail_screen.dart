...
class AcademyDetailsScreen extends StatefulWidget {
  ...
  AcademyDetailsScreen(this.academySlug);

  ActivityDetailsState createState() => ActivityDetailsState();
}

class ActivityDetailsState extends State<AcademyDetailsScreen> {
  bool isLoading = false;
  var usernameController = TextEditingController();
  var mobileController = TextEditingController();
  var ratingController=TextEditingController();
  Map<String,dynamic> academyResults={};
          ...
          : ListView(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    fit: BoxFit.fill,
                    image: AssetImage('assets/cricket_dummy.png'))),
          ),*/
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Image.asset('assets/verified_ic.png',
                                          width: 22, height: 20,color: Colors.red):
                                      Image.asset('assets/verified_ic.png',
                                          width: 22, height: 20),
                                      SizedBox(height: 5),
                                      Text(
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  ...
                                                  image: DecorationImage(
                                                      fit: BoxFit.fill,
                                                      image: NetworkImage(
                                                          packageImageUrl+packages[pos]['cover_image']))),
                                            ),
                                            SizedBox(width: 8),
                                            Expanded(
                                                child: Column(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    Text('₹ '+packages[pos]['price'].toString(),
                                                        style: const TextStyle(
                                                            fontSize: 14,
                                                            decoration:
                                                                TextDecoration
                                                            ...
                                                            color:
                                                                Colors.grey)),
                                                    SizedBox(width: 10),
                                                    Text('₹ '+packages[pos]['discount_price'].toString(),
                                                        style: const TextStyle(
                                                            fontSize: 14,
                                                            fontWeight:
                                                                FontWeight.w600,
                                                  ...
                                                  child: InkWell(
                                                    onTap:(){
                                                      Navigator.push(
                                                          ...
                                                          MaterialPageRoute(
                                                              builder: (context) =>
                                                                  SelectOfferScreen(packages[pos]['slug'])));
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Center(
                                                        child: Text(
                                                            packages[pos]['total_booking_seats'].toString()+' Available',
                                                            style: const TextStyle(
                                                                fontSize: 12,
                                                                color: AppTheme
                                                                    .blueColor)),
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              Spacer(),
                                              RatingBar.builder(
                                                initialRating: ratings[pos]["rating"]!=null?double.parse(ratings[pos]["rating"].toString()):0.0,
                                                minRating: 1,
                                                itemSize: 16,
  ...
  coachDetails(BuildContext context) async {
    ...
    var data = {
      "method_name": "facilityCenterDetailForHomePage",
      "data": {
        "facility_slug": widget.academySlug,
        "type": "facilities",
        "slug": AppModel.slug,
    ...
    /*{
      "method_name": "coachDetailForHomePage",
      "data": {
        "coach_slug": widget.coachSlug,
        "category_id": "5d498615ee90fb3fb1a59b9e",
        "type": "coach",
        "slug": AppModel.slug,
        "current_role": currentRole,
    ...
    var response =
        await helper.postAPI('facilityCenterDetailForHomePage', requestModel, context);
    var responseJSON = json.decode(response.body);
    if (responseJSON['decodedData']['status'] == 'success') {

      coachGalleryData = responseJSON['decodedData']['result']['gallery'];
      String baseUrl = responseJSON['decodedData']['gallery_url'];
      packageImageUrl= responseJSON['decodedData']['package_image_url'];
      aboutCoach = responseJSON['decodedData']['result']['about_organization'];
      contactInformation = responseJSON['decodedData']['result']['map_location'];
      packages = responseJSON['decodedData']['packages'];
      academyName = responseJSON['decodedData']['user_details']['first_name']+' '+responseJSON['decodedData']['user_details']['last_name'];
      ratings = responseJSON['decodedData']['reviews'];
      userProfileImage = responseJSON['decodedData']['image_url'];
      academyResults = responseJSON['decodedData']['result'];

      mapLocation = responseJSON['decodedData']['result']['map_location'];
      target = responseJSON['decodedData']['result']['_id'];
      targetName = responseJSON['decodedData']['result']['owner_name'];
      isKlubbaVerified =
      ...
      {
        Toast.show("Academy not found or has been disabled from Admin",
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () {
                            if(usernameController.text.isNotEmpty && mobileController.text.isNotEmpty)
                            {
                              Navigator.pop(context);
                                ...
                                Container(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        {
                                          reportUser(context, 'Report as inaccurate', userExperiencController.text);
                                        }
                                ...
                                Container(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        {
                                          reportUser(context, 'Report abuse', userExperiencController2.text);
                                        }
                                ...
                                Container(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        {
                                          reportUser(context, 'Report that business has shutdown', userExperiencController3.text);
                                        }
                                ...
                                Container(
                                  ...
                                  child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        {
                                          reportUser(context, 'Own listing', userExperiencController4.text);
                                        }
                                      }),
                                ),
                                SizedBox(height: 12)
                              ...
                              child: Row(
                                children: [
                                  GestureDetector(
                                      ...
                                      Icon(Icons.check_box_outline_blank_outlined),onTap: (){
                                    dialogState(() {
  ...
  sendInformationAPI(BuildContext context) async {
    ...
    var requestModel = {'req': base64.encode(utf8.encode(json.encode(data)))};
    ApiBaseHelper helper = ApiBaseHelper();
    var response = await helper.postAPI('sendInformationBySMS', requestModel, context);
    var responseJSON = json.decode(response.body);
    Navigator.pop(context);
    if(responseJSON['decodedData']['status']=='success')
    {
  ...
  reportUser(BuildContext context,String subject,String message) async {
    ...
    var data =
    {
      ...
      "data":{
        ...
        "message":message,
        "target":academyResults['_id'],
        "target_type":"facilities",
        "target_name":academyResults['profession_name'],
        "target_link":"",
        "subject":subject,
        "enquiry_type":"report",
        "first_name":name,
  ...
  _validateRating(){
    ...
    else if(!ratingIcon1 && !ratingIcon2 && !ratingIcon3 && !ratingIcon4 && !ratingIcon5 && !ratingIcon6)
    {
