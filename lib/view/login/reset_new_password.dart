...
class ResetNewPassword extends StatefulWidget{
  ...
  ResetNewPassword(this.currentPassword,this.slug,this.currentRole);
  _changePasswordState createState()=>_changePasswordState();
}

class _changePasswordState extends State<ResetNewPassword>{
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextFormField(
                      ...
                      enabled: widget.currentPassword==""?true:false,
...
@override
  void initState() {
    ...
    super.initState();
    currentController.text=widget.currentPassword;
  }
