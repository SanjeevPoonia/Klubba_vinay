...
import 'package:klubba/view/login/otp_screen_login.dart';
...
class LoginState extends State<LoginOTPScreen> {
  ...
  sendOTP(BuildContext context) async {
    ...
    var data ={"method_name":"sendOTPforLogin","data":{"mobile_number":loginController.text.toString()}};
    ...
    if (responseJSON['decodedData']['status'] == 'success') {
      ...
      if(responseJSON['decodedData']['message']=="No record found.")
        {
      ...
      else
        {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context)=>LoginOtpVerify(loginController.text.toString())));
        }
