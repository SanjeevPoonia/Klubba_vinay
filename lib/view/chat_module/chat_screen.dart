...
import 'package:klubba/view/chat_module/add_new_member.dart';
        ...
        child: FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => AddNewMemberScreen()));
            }),
      ),
          ...
          height: 10,
            ...
            isLoading?Center(child: Loader(),):
                ...
                ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int pos) {
                      ...
                      usersList=searchList[pos]['user'];
                      for(int i=0;i<usersList.length;i++){
                        if(usersList[i]['_id']!=userId){
                          userProfile=usersList[i]['profile_image']??"";
                          userName=usersList[i]['full_name'];
                          chatUserId=usersList[i]['_id'];
                        }
                      }
                      String lastMsg=searchList[pos]['latestMessage']!=null?searchList[pos]['latestMessage']:"";
                      ...
                      return InkWell(
                        onTap: (){
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      ChatScreenUser(searchList[pos]["_id"],chatUserId,userName,userProfile,false)));
                        },
                        onLongPress: (){
                          archiveChatBottomSheet(searchList[pos]["_id"]);
                        },
                        child: Container(
                          child: Column(
                            children: [
            ...
            ListView.builder(
                ...
                itemBuilder: (BuildContext context, int pos) {
                  ...
                  String lastMsg=chatList[pos]['latestMessage']!=null?chatList[pos]['latestMessage']:"";
                  String newMsg=chatList[pos]['newMessage'].toString();
                  String utcTime=chatList[pos]['updated_at'];
                  ...
                  return InkWell(
                    onTap: (){
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  ChatScreenUser(chatList[pos]["_id"],chatUserId,userName,userProfile,false)));
                    },
                    onLongPress: (){
                      archiveChatBottomSheet(chatList[pos]["_id"]);
                    },
                    child: Container(
                      child: Column(
                        children: [
